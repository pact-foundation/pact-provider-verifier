  ...
  module ProviderVerifier
    module CLI
      class Verify < CustomThor
        ...
        method_option :custom_middleware, type: :array, banner: 'FILE', desc: "Ruby file containing a class implementing Pact::ProviderVerifier::CustomMiddleware. This allows the response to be modified before replaying. Use with caution!", :required => false        method_option :verbose, aliases: "-v", desc: "Verbose output", :required => false
